...
<body<?= (!empty($bodyClass) ? ' class="' . implode(' ', $bodyClass) . '"' : '') ?> id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
<?php $this->load->view('clientArea/contentBox/module/headerBox'); ?>
